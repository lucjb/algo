 ...
 * |6 − 7| = 1 P = 4, difference = |10 − 3| = 7 Write a function: int
 * solution(int A[], int N); that, given a non-empty zero-indexed array A of N
 * integers, returns the minimal difference that can be achieved. For example,
 * given: A[0] = 3 A[1] = 1 A[2] = 2 A[3] = 4 A[4] = 3 the function should
 * return 1, as explained above. Assume that: N is an integer within the range
